...
For the paper, you can use data from any data set. There is also data located in the `critstats`, and in the `gss_cat` data located in the `forcats` package. A sample workflow is below.
