...
You can read more about the final paper [here](/papers/paper2.qmd).

See the instructions for paper assignments if you'd like to write more than one [here](/papers/papers-instructions.qmd).
